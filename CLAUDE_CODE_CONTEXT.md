...
**Dernière mise à jour :** 18 mai 2026 (v3.6.1.2 staging+preprod — CA estimé, delta formaté, tri criticité)
...
| v3.6.1.2 | ✅ Stable staging+preprod — **en test usage réel Cogex+Gers** | 34b094e |
...
| Recette (staging) | v3.6.1.2 (commit 34b094e) | https://d9xny9istvl53.cloudfront.net |
| Preprod | v3.6.1.2 (commit 34b094e) — en test usage réel | https://preprod.amazon.foliow.app |

⚠️ v3.6.0 + v3.6.1 + v3.6.1.1 + v3.6.1.2 non encore mergés en main — merge groupé uniquement après GO explicite de Fred à l'issue des tests usage réel (Cogex + Gers).
...
- **Si tests OK** → Fred donne GO merge → merge groupé v3.6.0 + v3.6.1 + v3.6.1.x → main → déploiement prod
...
**FIN CLAUDE_CODE_CONTEXT.md — màj : 18 mai 2026 (v3.6.1.2 staging+preprod — test usage réel en cours — v3.5.9 prod)**
