...
**Version :** V0.6 — 22 mai 2026 (fin de soirée)
...
| v3.6.10 | YoY Étape 3b — Couche causale défauts livraison | Automne 2026 | Réintègre les items (a) Buy Box reportés (croisement défauts × ASIN, BOL Mismatch). Nécessite import PO + jointure PO→ASIN, donc plus complexe. |
